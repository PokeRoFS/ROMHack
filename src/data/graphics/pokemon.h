...
#if P_FAMILY_REGIORIGIN
    const u32 gMonFrontPic_Regiorigin[] = INCBIN_U32("graphics/pokemon/regiorigin/anim_front.4bpp.lz");
    const u32 gMonPalette_Regiorigin[] = INCBIN_U32("graphics/pokemon/regiorigin/normal.gbapal.lz");
    const u32 gMonBackPic_Regiorigin[] = INCBIN_U32("graphics/pokemon/regiorigin/back.4bpp.lz");
    const u32 gMonShinyPalette_Regiorigin[] = INCBIN_U32("graphics/pokemon/regiorigin/shiny.gbapal.lz");
    const u8 gMonIcon_Regiorigin[] = INCBIN_U8("graphics/pokemon/regiorigin/icon.4bpp");
#if P_FOOTPRINTS
    const u8 gMonFootprint_Regiorigin[] = INCBIN_U8("graphics/pokemon/regiorigin/footprint.1bpp");
#endif //P_FOOTPRINTS
#endif //P_FAMILY_REGIORIGIN
