const struct Trainer gTrainers[] = {
    ...
    [TRAINER_SAWYER_1] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_HP_AWARE | AI_FLAG_WILL_SUICIDE | AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING,
    ...
    [TRAINER_BROTHER1] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_HP_AWARE | AI_FLAG_WILL_SUICIDE | AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING,
        .party = TRAINER_PARTY(sParty_Brother1),
    },
