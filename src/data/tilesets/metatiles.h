...
const u16 gMetatiles_gTileset_GeneralNew[] = INCBIN_U16("data/tilesets/primary/general_new/metatiles.bin");
const u16 gMetatileAttributes_gTileset_GeneralNew[] = INCBIN_U16("data/tilesets/primary/general_new/metatile_attributes.bin");

const u16 gMetatiles_gTileset_SnowConnection[] = INCBIN_U16("data/tilesets/secondary/snow_connection/metatiles.bin");
const u16 gMetatileAttributes_gTileset_SnowConnection[] = INCBIN_U16("data/tilesets/secondary/snow_connection/metatile_attributes.bin");

const u16 gMetatiles_gTileset_SnowRoute[] = INCBIN_U16("data/tilesets/secondary/snow_route/metatiles.bin");
const u16 gMetatileAttributes_gTileset_SnowRoute[] = INCBIN_U16("data/tilesets/secondary/snow_route/metatile_attributes.bin");

const u16 gMetatiles_snow_cave[] = INCBIN_U16("data/tilesets/secondary/snow_cave/metatiles.bin");
const u16 gMetatileAttributes_snow_cave[] = INCBIN_U16("data/tilesets/secondary/snow_cave/metatile_attributes.bin");
