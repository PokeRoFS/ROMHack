...
const struct Tileset gTileset_gTileset_GeneralNew =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_gTileset_GeneralNew,
    .palettes = gTilesetPalettes_gTileset_GeneralNew,
    .metatiles = gMetatiles_gTileset_GeneralNew,
    .metatileAttributes = gMetatileAttributes_gTileset_GeneralNew,
    .callback = NULL,
};

const struct Tileset gTileset_gTileset_SnowConnection =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_gTileset_SnowConnection,
    .palettes = gTilesetPalettes_gTileset_SnowConnection,
    .metatiles = gMetatiles_gTileset_SnowConnection,
    .metatileAttributes = gMetatileAttributes_gTileset_SnowConnection,
    .callback = NULL,
};

const struct Tileset gTileset_gTileset_SnowRoute =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_gTileset_SnowRoute,
    .palettes = gTilesetPalettes_gTileset_SnowRoute,
    .metatiles = gMetatiles_gTileset_SnowRoute,
    .metatileAttributes = gMetatileAttributes_gTileset_SnowRoute,
    .callback = NULL,
};

const struct Tileset gTileset_snow_cave =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_snow_cave,
    .palettes = gTilesetPalettes_snow_cave,
    .metatiles = gMetatiles_snow_cave,
    .metatileAttributes = gMetatileAttributes_snow_cave,
    .callback = NULL,
};
