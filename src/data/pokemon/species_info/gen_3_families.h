...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_CHIMECHO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_REGIORIGIN] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Regiorigin"),
        .cryId = CRY_REGIROCK,
        .natDexNum = NATIONAL_DEX_REGIORIGIN,
        .categoryName = _("Rock Peak"),
        .height = 17,
        .weight = 2300,
        .description = COMPOUND_STRING(
        ...
        .trainerScale = 309,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_Regiorigin,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Regiorigin,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        .backPic = gMonBackPic_Regiorigin,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_Regiorigin,
        .shinyPalette = gMonShinyPalette_Regiorigin,
        .iconSprite = gMonIcon_Regiorigin,
        .iconPalIndex = 2,
        FOOTPRINT(Regiorigin)
        .isLegendary = TRUE,
        .levelUpLearnset = sRegioriginLevelUpLearnset,
        .teachableLearnset = sRegioriginTeachableLearnset,
    },
