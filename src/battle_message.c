...
static const u8 sText_DontLeaveBirch[] = _("MR. HARSHBARGER: Don't leave me like this!\p");
...
static const u8 sText_WallyUsedItem[] = _("TRUEMAN used\n{B_LAST_ITEM}!");
...
const u8 gText_BattleWallyName[] = _("TRUEMAN");
